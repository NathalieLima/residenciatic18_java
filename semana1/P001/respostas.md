Classes são abstrações do mundo real. Elas surgem da necessidade de representar em código objetos do mundo real, por meio da programação orientada a objetos.
